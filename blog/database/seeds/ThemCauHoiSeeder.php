...
class ThemCauHoiSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cau_hoi[]=[
            ...
            "dap_an"=>"Nguyễn Thanh Thảo (Taekwondo)"
        ];
        $cau_hoi[]=[
        ...
        $cau_hoi[]=[
            ...
            "dap_an"=>"Trần Thánh Tông và Trần Nhân Tông"
        ];
        $cau_hoi[]=[
        ...
        $cau_hoi[]=[
            ...
            "phuong_an_b"=>"Ông Đồng",
            "phuong_an_c"=>"Tam Trinh",
            "phuong_an_d"=>"Đào Kỳ",
            "dap_an"=>"Tam Trinh"
        ];
        $cau_hoi[]=[
            "noi_dung"=>"Tập “Dư địa chí” được Nguyễn Trãi soạn dưới triều vua nào?",
            "linh_vuc_id"=>"2",
        ...
        $cau_hoi[]=[
            "noi_dung"=>"TVận tốc của sóng âm truyền trong môi trường nào lớn nhất?",
            "linh_vuc_id"=>"5",
        ...
        $i = 1;
        // Thêm câu hỏi vào bảng cau_hoi trong CSDL
